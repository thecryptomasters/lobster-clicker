...
func _run() -> void:
	...
	var numbered_fourth_building = main_ui.building_container.get_child(3)
	_expect(numbered_fourth_building.icon_texture.texture == null and numbered_fourth_building.icon_badge.visible, "later buildings retain readable numbered placeholders")
