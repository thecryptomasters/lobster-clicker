...
func _run() -> void:
	...
	var sixth_illustrated_building = main_ui.building_container.get_child(5)
	_expect(sixth_illustrated_building.icon_texture.texture != null and sixth_illustrated_building.icon_badge.visible == false, "first six buildings use illustrated arcade cabinet art")
	var numbered_seventh_building = main_ui.building_container.get_child(6)
	_expect(numbered_seventh_building.icon_texture.texture == null and numbered_seventh_building.icon_badge.visible, "later buildings retain readable numbered placeholders")
